...
`pip install`  
[`atlantis 🌋`](https://pypi.org/project/atlantis) [`abstract 🕸️`](https://pypi.org/project/abstract)  
[`pensieve 🧠`](https://pypi.org/project/pensieve) [`linguistics 🈺`](https://pypi.org/project/linguistics)  
[`amazonian 🐊`](https://pypi.org/project/amazonian) [`nightingale 🐦`](https://pypi.org/project/nightingale)  
